...
fn api_method_name(method: &Method) -> &'static str {
    match method {
        ...
        Method::PaneNotesList(_) => "pane.notes.list",
        Method::PaneNoteAdd(_) => "pane.notes.add",
        Method::PaneNoteRemove(_) => "pane.notes.remove",
        Method::PaneNotesClear(_) => "pane.notes.clear",
