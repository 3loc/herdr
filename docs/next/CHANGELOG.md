...
### Fixed
- Direct keybindings now run before copy-mode commands outside the search prompt, and modified special keys no longer act like their unmodified copy-mode commands. (#2242)
